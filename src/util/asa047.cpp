...
/*
 * GJ I modified this so that the evaluation function is std::function
 * rather than a function
 * pointer, so I can easily pass lambda expression and call class methods
 */
