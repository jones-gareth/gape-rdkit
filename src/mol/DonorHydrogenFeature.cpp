...
namespace Gape {
    const double DonorHydrogenFeature::hBondLen = 2.9;
    const double DonorHydrogenFeature::chargeFactor = 2.0;
    const double DonorHydrogenFeature::matchFactor = 1.0;

    const double DonorHydrogenFeature::maxDonorDonorAngle = 100.0 * M_PI / 180.0;
    const double DonorHydrogenFeature::minDonorDonorAngle = 60 * M_PI / 180.0;
    const bool DonorHydrogenFeature::scoreDonorAtoms = true;
